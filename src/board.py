                ...
                if token != self.empty:
                    ...
                    if col <= self.columns - 4:
                        if (
                            ...
                            and self.board[row][col + 2] == token
                            and self.board[row][col + 3] == token
                        ):
                            return token
                    ...
                    if row <= self.rows - 4:
                        if (
                            ...
                            and self.board[row + 2][col] == token
                            and self.board[row + 3][col] == token
                        ):
                            return token
                    ...
                    if row <= self.rows - 4 and col <= self.columns - 4:
                        if (
                            ...
                            and self.board[row + 2][col + 2] == token
                            and self.board[row + 3][col + 3] == token
                        ):
                            return token
